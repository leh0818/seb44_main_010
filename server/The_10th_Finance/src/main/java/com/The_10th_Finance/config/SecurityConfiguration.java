...
//                .and()
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .antMatchers("/consumption/profile/{userId}/{month}").permitAll()
                        .antMatchers("/consumption/daily/{userId}/{month}/{date}").permitAll()
                        .antMatchers("/consumption/category/{userId}/{Month}").permitAll()
                        .antMatchers("/consumption//monthly/{userId}/{Month}").permitAll()
                        .antMatchers("/consumption/day_upload").permitAll()
                        .antMatchers("/consumption/calender/{userId}/{Month}").permitAll()
                        .antMatchers("/consumption/myInfo/{userId}/{Month}").permitAll()
